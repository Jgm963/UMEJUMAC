        ...
        <div class="seccion-pilares">
            ...
            <details id="consultoria" class="acordeon-item">
                ...
                <div class="acordeon-content">
                    ...
                    <p>Aquí puedes agregar texto detallado sobre el material de capacitación o los informes de gestión realizados. Simplemente edita este texto con tu contenido. Puedes usar párrafos, listas y enlaces.</p>
                    
                    <ul>
                        <li>Análisis Estratégico de Riesgos.</li>
                        <li>Diseño de Planes de Prevención.</li>
                        <li>Resultados de Reuniones de Trabajo (Mes/Año).</li>
                    </ul>
            ...
            <details id="servicios" class="acordeon-item">
                ...
                <div class="acordeon-content">
                    ...
                    <p>Detalla aquí los servicios específicos que ofrece la firma (asesoría legal, desarrollo web, implementación de ERP/CRM, etc.).</p>
        ...
        <section id="ventas">
            ...
            <div class="product-grid">
                ...
                <div class="product-item">
                    <img src="ruta/a/tu/vehiculo.jpg" alt="Vehículo en Venta" class="product-image">
